...
import { Bold, Italic, Strikethrough, Heading1, Heading2, Heading3, List, ListOrdered, Quote, Undo2, Redo2 } from 'lucide-react';
  ...
  return (
    <div className="w-full h-full p-6 sm:p-8 flex flex-col relative overflow-y-auto">
      <input
        ...
        className="text-3xl sm:text-4xl font-bold bg-transparent border-none outline-none w-full mb-8 text-zinc-900 dark:text-zinc-50 placeholder:text-zinc-300 dark:placeholder:text-zinc-700 shrink-0"
        placeholder="Título de la nota"
      />

      {editor && (
        <BubbleMenu editor={editor} className="flex gap-1 bg-white dark:bg-zinc-800 p-1 rounded-lg shadow-lg border border-zinc-200 dark:border-zinc-700">
          <button
